...
dims everything else; clicking PINS the highlight (survives mouseout, click
again to release, cleared by any redraw; the pinned bar's marks thicken). A dimension bracket at the maximal steady-state moment
