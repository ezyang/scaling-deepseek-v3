...
T.check('default = peak stage under DualPipeV (1: two chunks, 8.5 mb in flight)', sels()[0].selectedOptions[0].textContent.includes('L3–6+L53–56') && sels()[0].selectedOptions[0].textContent.includes('peak'), sels()[0].selectedOptions[0].textContent);
